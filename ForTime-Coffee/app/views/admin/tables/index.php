                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody id="tableTableBody">
                                        <?php if (!empty($data['tables'])): ?>
                                            ...
                                            <tr class="table-row clickable-row <?php echo ($table->is_deleted == 1) ? 'table-secondary text-muted' : ''; ?>" 
                                                ...
                                                <td class="fw-bold text-dark">
                                                    ...
                                                    <?php if($table->is_deleted == 1): ?>
                                                        <span class="badge bg-danger ms-2" style="font-size: 0.65rem;">Đã xóa</span>
                                                    <?php endif; ?>
                                                </td>
...
<?php if($table->is_deleted == 1): ?>
    <a href="<?php echo URLROOT; ?>/table/restore/<?php echo $table->table_id; ?>" 
       class="btn btn-sm btn-success fw-bold btn-restore text-white">
...
<?php if(isset($_SESSION['msg_type']) && isset($_SESSION['msg_text'])): ?>
    <div id="flash-message" 
         data-type="<?php echo $_SESSION['msg_type']; ?>" 
         data-text="<?php echo $_SESSION['msg_text']; ?>"
